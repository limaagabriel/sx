...
script_parser = action_parsers.add_parser('script', help='Execute a listed script')
script_parser.add_argument('name', help='Select which script to execute')
script_parser.add_argument('-s', '--settings', default='application.yaml')

boot_parser = action_parsers.add_parser('boot', help='Manage sx-based applications')
boot_parser.add_argument('-s', '--settings', default='application.yaml')
...
export_parser.add_argument('-s', '--settings', default='application.yaml')
